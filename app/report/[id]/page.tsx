    ...
    <section className="report">
      ...
      <div className="report-grid">
        <div className="report-main">
          ...
          <div className="two"><ReportBlock tag="MARKET OPPORTUNITY" title="Where the signal may be." text={content.market} confidence={evidence.market} agent="MAP" /><ReportBlock tag="TARGET CUSTOMER" title="Who needs this most." text={content.customer} confidence={evidence.customer} agent="CUST" /></div>
          <div className="two"><ReportBlock tag="CUSTOMER PROBLEM" title="A job that won't wait." text={content.problem} confidence={evidence.customer} agent="CUST" /><ReportBlock tag="COMPETITIVE GAP" title="Win by being specific." text={content.gap} confidence={evidence.competitors} agent="COMP" /></div>
          <div className="two"><ReportBlock tag="COMPETITIVE TERRAIN" title="What they use today." text={content.competitors} confidence={evidence.competitors} agent="COMP" /><ReportBlock tag="BUSINESS MODEL" title="How it could work." text={content.businessModel || content.pricing} confidence={evidence.businessModel} agent="MODEL" /></div>

...
export default function Home() {
  ...
  return <main>
    <nav><a className="brand" href="/"><img src="/logo-mark.png" alt="" className="brand-mark" /> AI Co-Founder</a><div className="nav-links"><a href="#team">Meet the team</a><a href="/v2">V2 workspace</a><a href="/pricing">Pricing</a><a href="/reports">My reports</a><ThemeToggle/><button className="signin" onClick={() => router.push("/auth")}>Sign in <span>↗</span></button></div></nav>
